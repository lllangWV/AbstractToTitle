...
from config import LLAMA2_WEIGHTS_PATH,LLAMA2_PATH,ROOT_DIR

base_model=os.path.join(LLAMA2_WEIGHTS_PATH,'llama-2-7b-hf')
print(f"Llama model: {base_model}")

csv_file=os.path.join(ROOT_DIR,'data','processed','scopus_1.csv')
